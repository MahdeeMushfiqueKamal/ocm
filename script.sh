...
rm ocm
g++ -std=c++17 -pthread -o ocm main.cpp
...
./ocm test -k 22 -h 7 -w 1048576 -n 4 -t 4 -o output.bin -fa input/lhg22L20MC5x.fa -q input/test_exact_count_lhg22L20MC5x_20000.txt
